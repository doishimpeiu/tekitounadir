void conv2d(const float* x, const float* weight, const float* bias, int32_t width, int32_t height, xint32_t in_channels, int32_t out_channels, int32_t ksize, float* y) {
