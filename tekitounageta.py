...
# W1_int8 = np.round(W1*2**7).astype(np.int8)
# print("W1_int8")
# print(W1_int8)
# input()
...
# B1_int8 = np.round(W1*2**8).astype(np.int8)
# print("B1_int8")
# print(B1_int8)
# input()
...
# W2_int8 = np.round(W2*2**7).astype(np.int8)
# print("W2_int8")
# print(W2_int8)
# input()
...
# # print(np.max(B2))
# # input()
# B2_int8 = np.round(B2*2**7).astype(np.int8)
# print("B2_int8")
# print(B2_int8)
# input()
...
# W3_int8 = np.round(W3*2**7).astype(np.int8)
# print("W3_int8")
# print(W3_int8)
# input()
...
# B3_int8 = np.round(B3*2**7).astype(np.int8)
# print("B3_int8")
# print(B3_int8)
# input()
...
# W4_int8 = np.round(W4*2**7).astype(np.int8)
# print("W4_int8")
# print(W4_int8)
# input()
...
# B4_int8 = np.round(B4*2**7).astype(np.int8)
# print("B4_int8")
# print(B4_int8)
# input()
